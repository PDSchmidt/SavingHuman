class Dog {
    ...
    loadAnimations() {
        ...
        this.animations[2][0] = new Animator(ASSET_MANAGER.getAsset("Sprites/Dog/DogRunv2.png"), 0, 0, 64, 64, 12, .075, 12, 1);
        this.animations[2][1] = new Animator(ASSET_MANAGER.getAsset("Sprites/Dog/DogRunv2L.png"), 0, 0, 64, 64, 12, .075, 12, 1);
